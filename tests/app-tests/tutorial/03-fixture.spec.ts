...
import { World, routeWorld } from "./fixtures/world";

const test = baseTest.extend<{ world: World }>({
...
test.describe("contact list", () => {
  ...
  test('can see contacts on the side bar', async ({ page, world }) => {
...
test.describe("contact view", () => {
  test('can navigate to contact', async ({ page, world }) => {
...
test.describe("contact edit", () => {
  ...
  test('can edit contact', async ({ page, world }) => {
